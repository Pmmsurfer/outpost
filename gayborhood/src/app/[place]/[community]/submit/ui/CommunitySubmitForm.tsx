...
export function CommunitySubmitForm({ place, community }: Props) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        <p className="mb-1 font-courier text-xs uppercase tracking-[1px] text-faded">
          Posting to
        </p>
      ...
      <div>
        <label
          htmlFor="category"
          className="mb-1 block font-courier text-sm font-bold text-ink"
        >
          Category
        </label>
        <select
      ...
      <div>
        <label
          htmlFor="email"
          className="mb-1 block font-courier text-sm text-faded"
        >
      ...
      {isEvent && (
        <>
          ...
          <p className="font-bebas text-sm tracking-[2px] text-ink">
            EVENT DETAILS
          </p>
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
              <label
                htmlFor="event_date"
                className="mb-1 block font-courier text-sm text-ink"
              >
                Date
              </label>
              <input
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <label
              htmlFor="first_timers_welcome"
              className="font-courier text-sm text-ink"
            >
